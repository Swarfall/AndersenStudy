...
class WorkReport {
    var monday: Weak.Monday?
    var tuesday: Weak.Tuesday?
    var wednes­day: Weak.Wednes­day?
    var thursday: Weak.Thursday?
    var friday: Weak.Friday?
    var saturday: Weak.Saturday?
    var sunday: Weak.Sunday?
}

var report = WorkReport()
var sunday = report.sunday
sunday.
